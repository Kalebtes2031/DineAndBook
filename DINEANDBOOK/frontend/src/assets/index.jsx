...
const Home = () => {
  ...
  return (
    <Box>
      ...
      <Box
        id="hero"
        bgImage="linear-gradient(0deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.8)), url('/img/restaurant_insidepic.jpg')"
        bgSize="cover"
        bgPosition="75%"
        color="white"
        minH="200px"
      ...
      >
        ...
        >
          ...
          <Link href="/menu">
            <Image src="/img/menupic.jpg" alt="New Menu" borderRadius="md" />
          </Link>
          <Text mt={4}>
        ...
        >
          ...
          <Link href="">
            <Image src="/img/bookpic.jpg" alt="Book a Table" borderRadius="md" />
          </Link>
          <Text mt={4}>
        ...
        >
          ...
          <Image src="/img/chefpic.jpg" alt="Opening Hours" borderRadius="md" />
          <Text mt={4}>
